...
import { hasEffectiveModule } from "@/lib/module-access";
...
export default async function StatementDetailPage({
  ...
  const canOpenConnect = hasEffectiveModule(ctx.effectiveModules, ModuleKey.CONNECT);
  const priorAuthForClaim = canOpenConnect && stmt.claim
