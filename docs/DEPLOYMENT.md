...
1. **Output Directory:** leave default for Next.js (`.next`); Vercel’s Next preset handles it when Framework Preset is **Next.js**.
...
| Variable        | Purpose                                                |
| --------------- | ------------------------------------------------------ |
| `NEXT_PUBLIC`_* | Same brand overrides as marketing if needed in the app |
