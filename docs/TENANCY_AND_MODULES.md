...
|------|---------------------|------------------|
| 1 | **Build** | `Patient` → `Encounter` → `ClaimDraft` (+ `ClaimDraftLine`, `ClaimIssue`) |
...
*Last updated: 2026-04-19 — staff journey / data thread section; synthetic-test seed row clarified.*
